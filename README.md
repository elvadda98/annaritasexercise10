...
<head>
    <meta charset="UTF-8">
    <title>Vocabulary Practice - Guard, Lead, Claws, Taste, Hammer, Relatives, Rubbish, Outdoor, Factory</title>
    <style>
        :root {
            --primary: #64d404;
            --primary-dark: #2f9e44;
...
<div class="app-container">
    <header>
        ...
        <div class="score-badge" id="scoreDisplay">Score: 0 / 27</div>
    </header>
...
<script>
    ...
    const vocabItems = [
        {
            word: "guard",
            context: "",
            meaning: "a person, animal, or thing that protects or watches over someone or something",
            example: "A security guard checked everyone before they entered the building.",
            writingSentence: "At night, a dog was hired to __ the warehouse from intruders.",
            pronSentence: "The museum hired a new __ to watch the paintings during the day.",
            definition: "someone or something that protects or keeps watch"
        },
        {
            word: "lead",
            context: "as guinzaglio",
            meaning: "a rope or strap used for controlling a dog while you are walking it",
            example: "You must keep your dog on a lead in this park.",
            writingSentence: "The dog pulled so strongly on the __ that his owner had to buy a stronger one.",
            pronSentence: "Before leaving the house, she clipped the __ onto her dog’s collar.",
            definition: "a rope or strap used to control a dog during a walk"
        },
        {
            word: "claws",
            context: "",
            meaning: "the sharp, curved nails on an animal’s feet or hands",
            example: "The cat gently dug its claws into the sofa.",
            writingSentence: "The eagle’s sharp __ helped it catch the fish from the river.",
            pronSentence: "Be careful when playing with the cat; its __ can scratch you.",
            definition: "the sharp, curved nails of some animals"
        },
        {
            word: "taste",
            context: "",
            meaning: "the flavour of something you eat or drink, or the ability to recognize different flavours",
            example: "The soup had a strong taste of garlic and herbs.",
            writingSentence: "He took a bite of the cake and said the __ of chocolate was very rich.",
            pronSentence: "After she recovered from the flu, her sense of __ slowly returned.",
            definition: "the flavour of food or drink, or the sense that notices it"
        },
        {
            word: "hammer",
            context: "",
            meaning: "a tool with a heavy metal head used for hitting nails into wood or other materials",
            example: "He used a hammer to hang the picture on the wall.",
            writingSentence: "She grabbed a __ from the toolbox to fix the loose board on the fence.",
            pronSentence: "The builder hit the nail with a __ until it was deep in the wood.",
            definition: "a tool with a heavy head used to hit nails"
        },
        {
            word: "relatives",
            context: "",
            meaning: "members of your family who are not your parents or children, such as cousins, aunts, and uncles",
            example: "We visited our relatives in the countryside for the weekend.",
            writingSentence: "Every summer, her __ come from different countries to have a big family reunion.",
            pronSentence: "He invited all his __ to celebrate his grandmother’s birthday together.",
            definition: "family members such as cousins, aunts, uncles, and grandparents"
        },
        {
            word: "rubbish",
            context: "",
            meaning: "things that you throw away because you do not want them anymore; trash",
            example: "Please put your rubbish in the bin after lunch.",
            writingSentence: "They cleaned the park and filled several bags with the __ left on the ground.",
            pronSentence: "The city collects household __ early every Monday morning.",
            definition: "waste things that are thrown away; trash"
        },
        {
            word: "outdoor",
            context: "",
            meaning: "located, done, or used outside, not inside a building",
            example: "They planned an outdoor picnic by the lake.",
            writingSentence: "The school has a large __ playground where children can run and play.",
            pronSentence: "In summer, many people prefer __ activities like hiking and cycling.",
            definition: "happening or used outside, not inside a building"
        },
        {
            word: "factory",
            context: "",
            meaning: "a building or group of buildings where goods are made using machines",
            example: "She works in a factory that produces car parts.",
            writingSentence: "The old shoe __ closed last year when the company moved to a new city.",
            pronSentence: "The __ runs all night to keep up with the demand for products.",
            definition: "a place where goods are produced, usually with machines"
        }
    ];
    ...
    function buildPronSection() {
        ...
        if (recognition) {
            ...
            recognition.onend = () => {
                // Do nothing; waiting for next click
            };
        }
    }
